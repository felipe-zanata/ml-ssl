...
def tratar_imagens(pasta_origem, pasta_destino='ajeitado'):
    ...
    for arquivo in arquivos:
        ...
        # Mudar metodo cv2.
        _, imagem_tratada = cv2.threshold(imagem_cinza, 127, 255, cv2.THRESH_TOZERO or cv2.THRESH_OTSU)
    ...
    for arquivo in arquivos:
        ...
        imagem2 = Image.new("P", imagem.size, color='white')
